...
const componentJsTemplate = require('../templates/route/componentJsTemplate');
const componentTsTemplate = require('../templates/route/componentTsTemplate');
const componentCssTemplate = require('../templates/route/componentCssTemplate');
const componentLazyTemplate = require('../templates/route/componentLazyTemplate');
const componentTsLazyTemplate = require('../templates/route/componentTsLazyTemplate');
const componentStoryTemplate = require('../templates/route/componentStoryTemplate');
const componentTestEnzymeTemplate = require('../templates/route/componentTestEnzymeTemplate');
const componentTestDefaultTemplate = require('../templates/route/componentTestDefaultTemplate');
const componentTestTestingLibraryTemplate = require('../templates/route/componentTestTestingLibraryTemplate');
